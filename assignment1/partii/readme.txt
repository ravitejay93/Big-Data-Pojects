We are using wikipedia text corpus:
...
6) Run the jar file using the following command(the jar and input file should be in the same folder)
	hadoop jar partii-0.0.1-SNAPSHOT.jar partii.partii.DownloadDataLink <Input File> <location>
	hadoop jar partii-0.0.1-SNAPSHOT.jar partii.partii.DownloadDataLink input.txt hdfs://cshadoop1/user/<User ID>/
	Example:
	hadoop jar partii-0.0.1-SNAPSHOT.jar partii.partii.DownloadDataLink input.txt hdfs://cshadoop1/user/rxy160030/
